...
public:
   ...
   void EliminaOcurrenciasMejorado(char a_borrar){
      int esc = 0;
      int lec = 0;

      while (v[lec] != a_borrar){
         lec++;
         esc++;
      }
...
int main(){
   ...
   cout << "------MÉTODO ELIMINA OCURRENCIAS (EFICIENTE)-------" << endl;
   ...
   // Llamada al método EliminaOcurrenciasMejorado

   secuencia.EliminaOcurrenciasMejorado(a_borrar);
